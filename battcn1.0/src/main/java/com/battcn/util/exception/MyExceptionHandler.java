...
/**
 * 统一异常处理，有效地针对异步和非异步请求 不同异常会到不同页面 throw new ParameterException("XXXX") －－－－ > error-parameter.jsp throw new SystemException("XXXX") －－－－ > error-System.jsp throw new Exception("XXXX") －－－－ > error.jsp Status value 1001 业务异常返回 1001 1002 参数异常返回 1000 其他异常返回
 * 
 * @author lanyuan
 */

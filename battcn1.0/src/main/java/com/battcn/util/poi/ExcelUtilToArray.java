...
public class ExcelUtilToArray {
	 ...
	 * @author
	 */
	public static void createExcelFile(Workbook workBook, String sFileName, int iTotalSheetNum, String sNameTmp, List<String[]> aList, String sTypes[], HttpServletResponse response) throws Exception {

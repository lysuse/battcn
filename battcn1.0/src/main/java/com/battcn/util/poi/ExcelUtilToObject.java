...
public class ExcelUtilToObject {
	...
	public static List readExcelFileToObject(String sRealPath, int iSheetNum, Class<?> entityClass, boolean isTitle) throws Exception {
	...
	public static List<?> readExcelFileToObject(InputStream is, int iSheetNum, Class<?> entityClass, boolean isTitle) throws Exception {
		List arrayList = new ArrayList();
		Workbook workBook = WorkbookFactory.create(is);
		int iRowNum = 0; // 每个工作表中行数量
		int iCellNum = 0; // 每行中的单元数量
	 ...
	 * @author
	 */
	public static void createExcelFile(Workbook workBook, String sFileName, int iTotalSheetNum, String sNameTmp, List<?> aList, String header[], String sTypes[], HttpServletResponse response) throws Exception {

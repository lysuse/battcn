...
public class ExcelUtil {
	 ...
	 * @throws Exception
	 */
	public static ArrayList<String[]> adapterReadArray(String sRealPath, int iSheetNum, boolean isTitle) throws Exception {
	...
	public static List<Map<String, String>> adapterReadMap(String sRealPath, String key[], boolean isTitle) throws Exception {
		return adapterReadMap(sRealPath, 0, key, isTitle);
	}

	public static List<Map<String, String>> adapterReadMap(String sRealPath, int iSheetNum, String key[], boolean isTitle) throws Exception {
	...
	public static List<Map<String, String>> adapterReadMap(InputStream is, String key[], boolean isTitle) throws Exception {
		return adapterReadMap(is, 0, key, isTitle);
	}

	public static List<Map<String, String>> adapterReadMap(InputStream is, int iSheetNum, String key[], boolean isTitle) throws Exception {
	...
	public static void adapterWriteArray(String sFileName, String sNameTmp, List<String[]> aList, HttpServletResponse response) throws Exception {
		adapterWriteArray(null, sFileName, 0, sNameTmp, aList, null, response);
	}

	public static void adapterWriteArray(Workbook workBook, String sFileName, int iTotalSheetNum, String sNameTmp, List<String[]> aList) throws Exception {
		adapterWriteArray(workBook, sFileName, iTotalSheetNum, sNameTmp, aList, null, null);
	}

	public static void adapterWriteArray(Workbook workBook, String sFileName, int iTotalSheetNum, String sNameTmp, List<String[]> aList, String sTypes[], HttpServletResponse response) throws Exception {
		ExcelUtilToArray.createExcelFile(workBook, sFileName, iTotalSheetNum, sNameTmp, aList, sTypes, response);
	}

	public static void adapterWriteMap(String sFileName, List<Map<String, String>> aList, String header[]) throws Exception {
		adapterWriteMap(null, sFileName, 0, "工作页", aList, header, null, null);
	}

	public static void adapterWriteMap(String sFileName, String sNameTmp, List<Map<String, String>> aList, String header[]) throws Exception {
		adapterWriteMap(null, sFileName, 0, sNameTmp, aList, header, null, null);
	}

	public static void adapterWriteMap(String sFileName, String sNameTmp, List<Map<String, String>> aList, String header[], HttpServletResponse response) throws Exception {
		adapterWriteMap(null, sFileName, 0, sNameTmp, aList, header, null, response);
	}

	public static void adapterWriteMap(Workbook workBook, String sFileName, int iTotalSheetNum, String sNameTmp, List<Map<String, String>> aList, String header[]) throws Exception {
		adapterWriteMap(workBook, sFileName, iTotalSheetNum, sNameTmp, aList, header, null, null);
	}

	public static void adapterWriteMap(Workbook workBook, String sFileName, int iTotalSheetNum, String sNameTmp, List<Map<String, String>> aList, String header[], String sTypes[], HttpServletResponse response) throws Exception {
	...
	public void adapterWriteObj(String sFileName, String sNameTmp, List<?> aList, String header[], HttpServletResponse response) throws Exception {
		adapterWriteObj(null, sFileName, 0, sNameTmp, aList, header, null, response);
	}

	public void adapterWriteObj(Workbook workBook, String sFileName, int iTotalSheetNum, String sNameTmp, List<?> aList, String header[]) throws Exception {
		adapterWriteObj(workBook, sFileName, iTotalSheetNum, sNameTmp, aList, header, null, null);
	}

	public void adapterWriteObj(Workbook workBook, String sFileName, int iTotalSheetNum, String sNameTmp, List<?> aList, String header[], String sTypes[], HttpServletResponse response) throws Exception {
		ExcelUtilToObject.createExcelFile(workBook, sFileName, iTotalSheetNum, sNameTmp, aList, header, sTypes, response);
	}
}

...
public class TreeUtil {
	...
	public void main(String[] args) {
		/*
		 * long start = System.currentTimeMillis(); List<ResourceForm> ResourceFormList = new ArrayList<ResourceForm>();
		 * 
		 * ResourceFormUtil mt = new ResourceFormUtil(); List<ResourceForm> ns=mt.getChildResourceForms(ResourceFormList,0); for (ResourceForm m : ns) { System.out.println(m.getName()); System.out.println(m.getChildren()); } long end = System.currentTimeMillis(); System.out.println("用时:" + (end - start) + "ms");
		 */
	}
